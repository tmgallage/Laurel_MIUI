...
rm -rf /mnt/CC9E_ROM/system/app/Mipay >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/app/SecurityInputMethod >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/app/PaymentService >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/app/MiuiBugReport >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/data-app/MiShop >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/data-app/MiFinance >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/data-app/SmartHome >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/data-app/SmartTravel >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/data-app/GameCenter >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/data-app/MiuiScanner >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/data-app/Email >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/data-app/MiuiDriveMode >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/priv-app/YellowPage >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/priv-app/NewHome >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/priv-app/PersonalAssistant >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/app/VoiceAssist >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/app/AiAsstVision >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/app/MiRadio >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/app/Joyose >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/app/MSA >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/app/VsimCore >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/data-app/MiLiveAssistant >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/data-app/Youpin >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/data-app/VirtualSim >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/data-app/Huanji >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/data-app/wps-lite >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/priv-app/MiGameCenterSDKService >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/priv-app/ContentExtension >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/priv-app/MiService >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/priv-app/QuickSearchBox >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/data-app/VipAccount >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/data-app/XiaoAiSpeechEngine >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/data-app/XMRemoteController >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/product/app/talkback >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/data-app/CleanMaster >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/product/app/aiasst_service  >/dev/null 2>&1
rm -rf /mnt/CC9E_ROM/system/priv-app/MiuiVideo >/dev/null 2>&1

# Replacing some china ROM files using xiaomi.eu ROM files
if [ -d "Extra_Files/EU_Files/DownloadProvider" ] 
then
	rm -rf /mnt/CC9E_ROM/system/priv-app/DownloadProvider >/dev/null 2>&1
	rm -rf /mnt/CC9E_ROM/system/priv-app/DownloadProviderUi >/dev/null 2>&1
	rm -rf /mnt/CC9E_ROM/system/priv-app/Music >/dev/null 2>&1
	rm -rf /mnt/CC9E_ROM/system/app/MiRadio >/dev/null 2>&1
	rm -rf /mnt/CC9E_ROM/system/app/FM >/dev/null 2>&1
	cp -Raf Extra_Files/EU_Files/DownloadProvider /mnt/CC9E_ROM/system/priv-app/
	cp -Raf Extra_Files/EU_Files/DownloadProviderUi /mnt/CC9E_ROM/system/priv-app/
	cp -Raf Extra_Files/EU_Files/Music /mnt/CC9E_ROM/system/priv-app/
	cp -Raf Extra_Files/EU_Files/MiRadio /mnt/CC9E_ROM/system/app/
	cp -Raf Extra_Files/EU_Files/FM /mnt/CC9E_ROM/system/app/
fi

# Coping china default theme to use in xiaomi.eu ROM
cp -Raf /mnt/CC9E_ROM/system/media/theme Extra_Files/China_Files/
...
sed -i "/ro.product.system.model=/c\ro.product.system.model=MI A3
/ro.product.locale=/c\ro.product.locale=en-GB" /mnt/A3_ROM/system/build.prop
...
rm MiuiCamera.apk
uniq MiuiCamera/res/values/styles.xml MiuiCamera/res/values/styles-new.xml
rm MiuiCamera/res/values/styles.xml
cp MiuiCamera/res/values/styles-new.xml MiuiCamera/res/values/styles.xml
rm MiuiCamera/res/values/styles-new.xml
...
cd CC9E_ROM
file=$(find . -type f -iname "miui_LAURUS*.zip")
cd ..
if [[ $file =~ ./miui_(.*)_(.*)_(.*)_(.*)\.zip$ ]]; then
...
cd output
rm MIUI_CN_MIA3_"$part2"_v12-"$part4"-BITNET.zip >/dev/null 2>&1
rm MIUI_CN_MIA3_"$part2"_v12-"$part4"-BITNET.zip.md5 >/dev/null 2>&1
zip -r MIUI_CN_MIA3_"$part2"_v12-"$part4"-BITNET.zip firmware-update GApps install META-INF boot.img system.img vendor.img
md5sum MIUI_CN_MIA3_"$part2"_v12-"$part4"-BITNET.zip > MIUI_CN_MIA3_"$part2"_v12-"$part4"-BITNET.zip.md5
cd ..
...
cd ..
echo Cleaning Done ...
echo CC9E to A3 Porting Process Done : output/MIUI_CN_MIA3_"$part2"_v12-"$part4"-BITNET.zip
